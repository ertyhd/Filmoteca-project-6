var t="undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:"undefined"!=typeof global?global:{};function e(t){return t&&t.__esModule?t.default:t}var n={},i={},r=t.parcelRequired7c6;null==r&&((r=function(t){if(t in n)return n[t].exports;if(t in i){var e=i[t];delete i[t];var r={id:t,exports:{}};return n[t]=r,e.call(r.exports,r,r.exports),r.exports}var s=new Error("Cannot find module '"+t+"'");throw s.code="MODULE_NOT_FOUND",s}).register=function(t,e){i[t]=e},t.parcelRequired7c6=r),r("kyEFX").register(JSON.parse('{"5ZPII":"index.c820fce3.js","7uzI0":"catch-error-pagination.5e5b9d69.14fa01de.jpg","lk5QZ":"my_library.b070715d.css","8z6c1":"my_library.dd06a79e.js"}')),r("1VOaQ"),r("2hTmC");
/**
 * @license
 ...
 * limitations under the License.
 */
const $c=N("authIdTokenMaxAge")||300;let Wc=null;var qc;qc="Browser",Nt(new K("auth",((t,{options:e})=>{const n=t.getProvider("app").getImmediate(),i=t.getProvider("heartbeat"),{apiKey:r,authDomain:s}=n.options;return((t,n)=>{lo(r&&!r.includes(":"),"invalid-api-key",{appName:t.name}),lo(!(null==s?void 0:s.includes(":")),"argument-error",{appName:t.name});const i={apiKey:r,authDomain:s,clientPlatform:qc,apiHost:"identitytoolkit.googleapis.com",tokenApiHost:"securetoken.googleapis.com",apiScheme:"https",sdkClientVersion:na(qc)},o=new ra(t,n,i);return function(t,e){const n=(null==e?void 0:e.persistence)||[],i=(Array.isArray(n)?n:[n]).map(po);(null==e?void 0:e.errorMap)&&t._updateErrorMap(e.errorMap),t._initializeWithPersistence(i,null==e?void 0:e.popupRedirectResolver)}(o,e),o})(n,i)}),"PUBLIC").setInstantiationMode("EXPLICIT").setInstanceCreatedCallback(((t,e,n)=>{t.getProvider("auth-internal").initialize()}))),Nt(new K("auth-internal",(t=>(t=>new zc(t))(sa(t.getProvider("auth").getImmediate()))),"PRIVATE").setInstantiationMode("EXPLICIT")),Ft(Bc,Vc,function(t){switch(t){case"Node":return"node";case"ReactNative":return"rn";case"Worker":return"webworker";case"Cordova":return"cordova";default:return}}(qc)),Ft(Bc,Vc,"esm2017"),r("eWCmQ");const Gc={apiKey:"AIzaSyBAxD1d6Q1iAwziX2Na8ubQZJCLhj-Pvhg",authDomain:"project-b3c7f.firebaseapp.com",databaseURL:"https://project-b3c7f-default-rtdb.europe-west1.firebasedatabase.app",projectId:"project-b3c7f",storageBucket:"project-b3c7f.appspot.com",messagingSenderId:"815844014735",appId:"1:815844014735:web:4184be206f1dcdb43b4efa"},Kc=Ut(Gc);(function(t,e){const n="string"==typeof t?t:e||"(default)",i=Lt("object"==typeof t?t:jt(),"firestore").getImmediate({identifier:n});if(!i._initialized){const t=P("firestore");t&&Ks(i,...t)}})(Kc),function(t=jt()){const e=Lt(t,"auth");if(e.isInitialized())return e.getImmediate();const n=function(t,e){const n=Lt(t,"auth");if(n.isInitialized()){const t=n.getImmediate();if(F(n.getOptions(),null!=e?e:{}))return t;so(t,"already-initialized")}return n.initialize({options:e})}(t,{popupRedirectResolver:Hc,persistence:[Qa,xa,Ua]}),i=N("authTokenSyncURL");if(i){const t=(r=i,async t=>{const e=t&&await t.getIdTokenResult(),n=e&&((new Date).getTime()-Date.parse(e.issuedAtTime))/1e3;if(n&&n>$c)return;const i=null==e?void 0:e.token;Wc!==i&&(Wc=i,await fetch(r,{method:i?"POST":"DELETE",headers:i?{Authorization:`Bearer ${i}`}:{}}))});!function(t,e,n){G(t).beforeAuthStateChanged(e,n)}(n,t,(()=>t(n.currentUser))),function(t,e,n,i){G(t).onIdTokenChanged(e,n,i)}(n,(e=>t(e)))}var r;const s=O("auth");s&&aa(n,`http://${s}`)}(Kc);firebase.initializeApp(Gc);document.querySelector("#header-myLibrary");document.getElementById("dashboard").style.display="none",document.getElementById("login").addEventListener("click",(function(){console.log("Login Btn Call"),firebase.auth().signInWithPopup(Xc).then((t=>{console.log(t.user),Jc(t.user)})).catch((t=>{console.log(t)}))})),document.getElementById("logout").addEventListener("click",(function(){console.log("Logout Btn Call"),firebase.auth().signOut().then((()=>{document.getElementById("LoginScreen").style.display="block",document.getElementById("dashboard").style.display="none"})).catch((t=>{console.log(t)}))}));let Xc=new firebase.auth.GoogleAuthProvider;function Jc(t){document.getElementById("userDetails").innerHTML=`\n    <img src="${t.photoURL}" class="photo_user">\n    <p class="name">${t.displayName}</p>\n  `}firebase.auth().onAuthStateChanged((t=>{t&&(document.getElementById("LoginScreen").style.display="none",document.getElementById("dashboard").style.display="flex",Jc(t))}));var Yc,Qc=r("3ydHb"),Zc=r("eWCmQ"),tl={};window,
/*!
 * TOAST UI Pagination
 * @version 3.4.1
